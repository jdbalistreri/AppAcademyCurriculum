...
ActiveRecord::Schema.define(version: 20150212214108) do
  ...
  add_index "albums", ["name", "recording_year", "band_id"], name: "index_albums_on_name_and_recording_year_and_band_id", unique: true, using: :btree
