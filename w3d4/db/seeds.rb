...
AnswerChoice.create!(body: "so good", question_id: q1.id)
AnswerChoice.create!(body: "the best", question_id: q1.id)
AnswerChoice.create!(body: "alright", question_id: q1.id)
AnswerChoice.create!(body: "ya nah", question_id: q1.id)
